...
const STRATEGY_REGISTRY = [
  ...
  { id: 'screener',   label: '🔎 Breakout',           kind: 'signal', section: 'screener', horizon: 'swing',    core: true,  maturity: 'production', scoringVersion: 'screener-v1', criteria: 'Beat SPY/sector over ≥20 resolved.' },
  { id: 'momentum',   label: '🔥 Momentum',           kind: 'signal', section: 'momentum', horizon: 'position', core: true,  maturity: 'production', scoringVersion: 'momentum-v1' },
  { id: 'ghost',      label: '👻 Ghost Accumulation',  kind: 'signal', section: 'Ghost',    horizon: 'swing',    core: true,  maturity: 'production', scoringVersion: 'ghost-v1' },
  { id: 'gapgo',      label: '🚀 Gap & Go',            kind: 'signal', section: 'GapGo',    horizon: 'intraday', core: true,  maturity: 'production', scoringVersion: 'gapgo-v1', note: 'The one deflation-surviving event edge; tracked via its own ledger.' },
  ...
  { id: 'coil',       label: '🧬 Coil Radar',          kind: 'signal', section: 'coil',     horizon: 'swing',    core: true,  maturity: 'production', scoringVersion: 'coil-v1', note: 'Compression predicts ABNORMAL moves, not trade R — treat as a watchlist/trigger detector; trade-utility promotion is a separate bar (see lib/strategy-contracts.js).' },
  { id: 'custom',     label: '🧠 Adaptive Momentum',   kind: 'signal', section: null,       horizon: 'position', core: true,  maturity: 'production', scoringVersion: 'apex-v3', note: 'Apex model — tracked via its own drift/rank-quality panel.' },
  { id: 'biotech',    label: '🧬 Biotech Radar',       kind: 'signal', section: 'Biotech',  horizon: 'swing',    core: true,  maturity: 'production', scoringVersion: 'biotech-v1' },
  { id: 'downday',    label: '🪁 Down-Day Bounce',     kind: 'signal', section: 'DownDay',  horizon: 'swing',    core: true,  maturity: 'production', scoringVersion: 'downday-v1', note: 'Red-tape-only conditional sleeve (validated context). Its SHORT side (overheated fades) is borrow-gated fail-closed by lib/eligibility.js — no borrow feed means research/watch only.' },
  ...
  { id: 'ignition',   label: '🔥 Momentum Ignition',   kind: 'signal', section: 'Ignition', horizon: 'swing',    core: true,  maturity: 'production', scoringVersion: 'ignition-v1' },
  ...
  { id: 'fade',       label: '🔥 Overheated (Fade)',   kind: 'signal', section: 'Fade',       horizon: 'swing',    core: false, maturity: 'shadow', scoringVersion: 'fade-v1', note: 'Validated ONLY as an AVOID filter on loud bullish social names (the measured edge is entirely short-side, and there is no borrow feed) — never a live short book.' },
