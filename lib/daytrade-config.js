...
//
// WHY THESE EXIST. During regular hours the screener runs off a daily-candle cache built
// pre-open, so a candidate's newest DAILY bar is a PRIOR session. A daily bar can DISCOVER
