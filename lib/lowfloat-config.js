...
const DISCOVERY = Object.freeze({
  ...
  GAP_MIN_PCT: 4.0,
  // Premarket gap lane: the SAME gap threshold, plus a floor on premarket participation
  // expressed against the FULL-DAY average volume (never paced to the regular-hours curve).
  // 0.05 = five percent of a normal day's shares have already printed before 09:30.
  PREMARKET_GAP_MIN_REL_VOL: 0.05,
