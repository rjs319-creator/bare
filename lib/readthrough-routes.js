...
const { readJSON, writeJSON, hasStore, readAllGapDays } = require('./store');
...
async function generate(t0) {
  ...
  return { items: ranked, notes, triggerDate: latest.date, triggers, regime: latest.regime || null };
}
...
module.exports = { runReadThrough, generate, attachTapeMoves, CACHE_KEY };
