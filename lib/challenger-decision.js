...
function decideOne(sig, ctx = {}, flags = {}) {
  ...
  if (failureProb != null && failureProb > CONFIG.maxFailureProb) { reasons.push(`failure-risk score ${failureProb} exceeds ${CONFIG.maxFailureProb}`); return { ...base, decision: 'AVOID', reasons }; }
