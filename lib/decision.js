...
function scoreInformativeness(sectionDecile, section) {
...
function rankSignals(signals, { regime, scoreboard, includeInactive = false, redundancy = null, origins = null } = {}) {
  ...
  const enriched = (signals || []).map((sig) => {
    ...
    const informativeness = scoreInformativeness(scoreboard && scoreboard.sectionDecile, sig.section || sig.source);
...
module.exports = {
  ...
  scoreInformativeness, informedConfidence, INFORMATIVENESS_W,
