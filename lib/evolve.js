...
function scoreCandidate(sig, ctx = {}) {
  ...
  return {
    ...
    strengthAdjustedP: strengthTilt ? strengthTilt.p : null,   // SHADOW #9 — not in the decision/rank
...
module.exports = {
  ...
  evolveScore, contextKey, capBucket, scoreCandidate, fitCalibrator, applyCalibrator, binnedMap, oofCalibratorBrier, candidateStrengthTilt, buildEvolve,
};
