 ...
 *            agreement, reliability, estimatedCostFraction, quality }]
 */
function componentsForDate(rows, cfg) {
  ...
  const costPct = percentileRanks(rows.map((r) => (isFin(r.estimatedCostFraction) ? r.estimatedCostFraction : null)));
