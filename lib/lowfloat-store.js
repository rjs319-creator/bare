...
//   lowfloat/catalyst-cache.json                       catalyst metadata by ticker
...
const CATALYST_CACHE_KEY = 'lowfloat/catalyst-cache.json';
...
const readCatalystCache = () => readJSON(CATALYST_CACHE_KEY, null);
const writeCatalystCache = doc => writeJSON(CATALYST_CACHE_KEY, doc, 0);
...
module.exports = {
  ...
  UNIVERSE_KEY, FLOAT_CACHE_KEY, CATALYST_CACHE_KEY, PROMOTION_KEY, ALERT_STATE_KEY,
  ...
  readCatalystCache, writeCatalystCache,
