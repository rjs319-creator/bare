 ...
 * row does not). Both rankings are recorded per row; the point (an expected residual
  ...
  return (scoredRows || [])
    ...
    .map((r) => {
      ...
      return {
        ...
        betaSectorMarket: isFin(b.betaSectorMarket) ? b.betaSectorMarket : null,
        sector: r.sector || b.sector || null,
        sectorEtf: b.sectorEtf || null,
