...
async function runPulse2(req, res) {
  ...
  return res.json({
    ...
    // Per-leg macro provenance for the strategic layer, including WHY any leg is missing.
    macroDiagnostics: marketStateDoc ? marketStateDoc.macroDiagnostics || null : null,
    playbook,
