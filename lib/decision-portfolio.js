...
// `knownSector` is exported for the optimizer SHADOW lane (lib/decision-routes.js), so
// the shadow book applies the SAME unknown-placeholder rule as the live book.
module.exports = { METHOD, DEFAULTS, EXCLUSION_LABEL, buildPortfolio, knownSector };
