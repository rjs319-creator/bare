  ...
  return {
    ...
    verdict: !research || !research.factors
      ...
      : validated > 0
        ...
        : `No strategy yet beats SPY + sector at significance${bestBar ? ` — the bar to beat is a simple ${bestBar.name.toLowerCase()} rank (IC ${bestBar.rankIC}).` : '.'} Consistent with the app's honest finding: only momentum carries weak edge, and regime avoidance is the one durable lever.`,
  };
}
