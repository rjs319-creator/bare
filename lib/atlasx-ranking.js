...
function featureRow({ residual, transition, path, expert } = {}) {
  return Object.freeze({
    residMom5: residAt(residual, RESID_FEATURE_HORIZONS.short),
    residMom10: residAt(residual, RESID_FEATURE_HORIZONS.mid),
    residMom20: residAt(residual, RESID_FEATURE_HORIZONS.long),
    residAccel: residAccelFeat(residual),
