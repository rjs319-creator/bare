...
// Sections whose ledgers carry no liquidity scope stamp but whose universes are NOT
// large-cap: their contracts declare `unknown-liquidity-must-not-assume-cheapest`
// (lib/strategy-contracts.js), yet the old default graded every unstamped pick at the
// 'liquid' 16bps round trip — flattering exactly the illiquid sleeves. Anomaly scans
// MICRO_CAPS by design; the other event/narrative sleeves scan the mixed
// large∪small∪micro universe, so they default to the small-cap tier, not the cheapest.
