...
// wins; unstamped picks fall back to their section's declared universe tier, and only
// sections with a genuinely large-cap universe default to 'liquid'.
function tierForPick(p) {
  ...
  return SECTION_TIER_DEFAULT[p.section] || 'liquid';
}
