...
const CHAINS = {
  ...
  // consumer reads pitdata/*.
  pitdata: ['op=pitdata&view=collect', 'op=pitdata&view=v3collect', 'op=pitdata&view=v3health'],
...
const ROOT_CHAINS = ['ledger', 'capture', 'ticks1', 'ticks2', 'ticks3', 'aligned', 'universe', 'pulse', 'router', 'maturity', 'researchgrade', 'evolve', 'swing', 'atlasx', 'rlt', 'altprobes', 'govdemand', 'gridlock', 'swingsearch', 'pattern', 'peerprop', 'expgap', 'pitdata'];
