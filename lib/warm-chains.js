...
const CHAINS = {
  ...
  universe: ['@universescan1', '@universescan2', '@universescan3', '@universescan4', 'op=universecompile', 'op=secmasterbuild'],
  ...
  alphacal: ['op=calarchive', 'op=revarchive'],
...
const ROOT_CHAINS = ['ledger', 'capture', 'ticks1', 'ticks2', 'ticks3', 'aligned', 'universe', 'pulse', 'router', 'maturity', 'researchgrade', 'evolve', 'swing', 'atlasx', 'rlt', 'altprobes', 'govdemand', 'gridlock', 'swingsearch', 'pattern', 'peerprop', 'expgap', 'pitdata', 'alphacal', 'gexa', 'vrp', 'ephemeral'];
