...
const ROOT_CHAINS = ['ledger', 'capture', 'ticks1', 'ticks2', 'ticks3', 'aligned', 'universe', 'pulse', 'router', 'researchgrade', 'evolve', 'swing', 'atlasx', 'altprobes', 'swingsearch', 'evidence', 'pattern'];
