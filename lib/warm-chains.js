...
const CHAINS = {
  ...
  reprime: ['op=today', 'op=ensemble', 'op=challengerlog', 'op=orbitlog', 'op=orbitmltick', '@evolve'],
...
const ROOT_CHAINS = ['ledger', 'capture', 'ticks1', 'ticks2', 'ticks3', 'aligned', 'universe', 'pulse', 'router', 'researchgrade'];
