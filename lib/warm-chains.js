...
const CHAINS = {
  ...
  // the tick reads StockTwits trending + ~30 symbol streams (no FMP, no Yahoo — it
  // cannot contribute to the 22:00 bursts) and appends the write-once ledger day of
  // fresh ≥90%-bull crossings; the resolve scores ONE matured day (≥9 calendar days,
  // ≤60 candle fetches, dilution-identical excess5). Both idempotent.
