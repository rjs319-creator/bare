...
function gradeEpisode(episode, series = {}, opts = {}) {
  ...
  return {
    ...
    side: episode.side,
    // the decision-time signal strength, carried so governance can walk-forward test
    // whether stronger signals actually predict larger excess (score vs outcome IC).
    score: episode.firstSeenState && episode.firstSeenState.score != null ? episode.firstSeenState.score : null,
