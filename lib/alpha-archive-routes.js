...
// limit param at 100 — limit=250 is rejected with an error body on EVERY call,
// which is why the eager first-night "burst 429" diagnosis was wrong: the
// failure was deterministic. The 503-on-total-failure change is what exposed it.
const REV_PAGES = 8, REV_PAGE_LIMIT = 100;
