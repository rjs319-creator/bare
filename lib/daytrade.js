...
function dayMetrics(candles, spyByDate, avgWindow = AVG_VOL_WINDOW, pace = 1) {
  ...
  const relVol = (pace > 0 && pace < 1) ? rawRelVol / pace : rawRelVol;   // intraday-prorated for display
