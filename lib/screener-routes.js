...
async function runDaytrade(req, res) {
  ...
  return res.json({
    ...
    strategyVersion: 'daytrade-pit-v2',
    dataFreshness: { sessionDate: live.spyLastDate, shown: _shown.length, staleCandidates, generatedAt: new Date().toISOString() },
