...
const BEST_CARRY_FLOOR = 50;                              // above pcarry BASE_RATE (~49% beat-SPY)
const BEST_FADE_CATALYSTS = ['FADE_OFFERING', 'MA'];      // dilution / M&A pops that fade
...
function buildBestOpportunities(pool, limit = 12) {
  ...
  return pool.filter(passesQualityGate)                   // fade-avoidance gate (not just green+scored)
