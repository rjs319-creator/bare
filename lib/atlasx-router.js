...
const CORRELATION = Object.freeze([
  ...
  // RLT shares the residual-leadership premise with firstPullback and fires on
  // the same pivots as breakoutContinuation/compressionRelease — leadership +
  // momentum + trend are NOT independent confirmations of one price path.
  Object.freeze(['relativeLeadershipTransition', 'firstPullback', 0.5]),
  Object.freeze(['relativeLeadershipTransition', 'breakoutContinuation', 0.45]),
  Object.freeze(['relativeLeadershipTransition', 'compressionRelease', 0.35]),
]);
