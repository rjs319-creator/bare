...
async function runLifecycle(req, res) {
  ...
  [...board.actionableNow, ...board.reversalReclaim, ...board.armed, ...board.buildingNearTrigger, ...board.tooExtended, ...board.managing].forEach((r, i) => shownOrder.set(r.ticker, i));
