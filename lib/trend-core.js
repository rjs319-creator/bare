...
// quant-redesign-3: aligned with SOURCE_FAMILY — 'breakout' (not a SOURCE_FAMILY id) was
// listed while gapgo/daytrade/coil (which ARE mapped to priceTrend) were missing, so the
// consolidated read silently under-counted the domain's engines. Guarded by test.
const PRICE_TREND_ENGINES = Object.freeze(['screener', 'momentum', 'coremo', 'apex', 'ignition', 'trendrider', 'confluence', 'gapgo', 'daytrade', 'coil']);
