...
const SYSTEM = [
  ...
  'If a MEASURED RECORD of your prior plans is provided, treat it as ground truth about your own recent calibration — it is computed deterministically from realized SPY moves, never self-reported. A record running wrong means correct toward the tape, not repeat the stance. Explicitly resolve every listed OPEN PREDICTION in narrativeUpdate (confirmed / invalidated / still open).',
