...
const SMALL_CAPS = [
  ...
  'PLUG','FCEL','BE','RUN','SHLS','ARRY','AMRC','MAXN','CSIQ','JKS','NXT','FLNC','STEM','OKLO','SMR',
  // Internet / consumer / e-commerce
  'FUBO','RUM','YELP','CARG','OPEN','COMP','EXPI','CARS','TRIP','YETI','CROX','BIRD','FIGS','WW','SKIN','OLPX','HELE','REAL','RVLV','BKE','SFIX',
