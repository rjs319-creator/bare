...
function classifyStatus(r) {
  ...
  // 404 is the provider saying the SYMBOL no longer exists — permanent and actionable
  // (prune or rename), unlike an 'empty' payload from a symbol that does exist. Verified
  // against a real rename: BK 404s, its successor BNY returns 200.
