...
// Replays the CURRENT engine — bumped with it (screener-v2: volume-surge admission
// and techScore credits removed). Replay artifacts produced before the bump were
// earned under screener-v1 and carry that stamp; the two never merge.
const SCORING_VERSION = 'screener-v2';
