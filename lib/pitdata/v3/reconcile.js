...
function reconcileV3(inputs = {}) {
  ...
  const gateResults = {
    ...
    lowConfidenceIdentity: n > 0 && frac(lowConf.length, n) <= gates.maxLowConfidenceFrac,
  ...
  return {
    ...
    counts,
    fractions: {
      lowConfidence: +frac(lowConf.length, n).toFixed(4),
...
module.exports = { GATES_V3, reconcileV3, makePromotionProposal };
