...
// One ticker's {company, price, day, d5, m1} from its daily candles, or null on
// failure. The company name rides along from Yahoo's chart meta (already fetched —
// no extra call) so mover rows for names surfaced only via options flow / forecasts
// (not in today's screen) still show a company label instead of a bare ticker.
