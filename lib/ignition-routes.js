...
async function runIgnitionBackfillOp(req, res) {
  ...
  for (const [date, picks] of Object.entries(byDate)) {
    try { await S.writeIgnitionDay(date, picks); written++; } catch { /* skip a failed day */ }
  }
...
module.exports = { runIgnition, runIgnitionLog, runIgnitionBackfillOp, buildIgnition, shortlistFromToday, catalystFromSignal };
