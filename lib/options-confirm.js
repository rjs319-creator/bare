...
// the lean is strongly directional (low unknown share), and 'thin' when the aggregate is
// NOT provisional, suspected multi-leg dominates, or the flow is almost entirely unknown.
function evidenceQuality(flow) {
  ...
  if (multiLeg >= 2 || unknownShare > 0.85) return 'thin';      // genuinely muddy despite a nominal lean
