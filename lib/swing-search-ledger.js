...
async function runSwingSearchLog(req, res) {
  ...
  return res.status(200).json({ ok: true, date, cohort, logged: snaps.length, requested: tickers.length, budgetSkipped: skipped });
}
...
module.exports = {
  ...
  runSwingSearchLog, runSwingSearchGrade, resolveLogUniverse, lightRegime,
