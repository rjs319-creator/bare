...
async function runScoreboard(req, res) {
  ...
  if (hasStore()) {
    ...
    for (const [sec, v] of Object.entries(scoreBySection)) {
      ...
      sectionDecile[sec] = { verdict: v.verdict, ic: v.ic && v.ic.ic, t: v.ic && v.ic.t, significant: !!(v.ic && v.ic.significant), n: v.n, method: v.method, spread: v.topBottomSpread, horizon: SCORE_HK };
    }
