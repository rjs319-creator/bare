...
function runExperimentV3(events, rankers, opts = {}, meta = {}) {
  ...
  for (const r of candidates) {
    ...
    pairedTests.push({
      ...
      // Student-t at df = pairedN − 1 (audit 2026-08-14): the normal CDF is
      // anti-conservative at the paired-date counts these tests actually see, and
      // these p's feed the BH denominator below.
      p: nw.tstat == null ? null : ST.pFromT(nw.tstat, Math.max(1, paired.pairedN - 1)),
