...
const FEATURE_KEYS = Object.freeze([
  ...
  'mom121',                        // 12-1 momentum: close[t-21]/close[t-252] - 1 (skip-month), the required swing benchmark
...
function computeFeatureVector(candles, idx, opts = {}) {
  ...
  // 12-1 momentum (Jegadeesh-Titman skip-month): needs a year of bars, else null — never proxied.
