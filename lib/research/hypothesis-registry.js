...
const HYPOTHESES = Object.freeze([
  ...
  {
    id: 'insider-cluster-residual', familyId: 'alt-signals', mode: 'exploratory', status: 'open',
    ...
    evidence: 'OPEN — registered 2026-09-09 before any event on this universe was constructed; result to be appended to research/experiments/registry.json (id insider-cluster-residual-2026-09) and research/data/insider-cluster-residual/',
    note: 'Known at registration: insider-cluster-drawdown (no-edge, 2026-08-05) and its comparison cohorts (unconditional clusters n=26 negative; single buyers n=235 21s +2.2% t 1.96) on a ~184-name present-day universe. The ~130 prior events are a subset of this sample.',
  },
