...
const HYPOTHESES = Object.freeze([
  ...
  },
  {
    ...
    evidence: 'research/data/sue.json (panel-v2 rerun) + apex/pead.json (surprise mode)',
    note: 'clean-panel rerun: pooled IC 0.006, t 1.76 < 2, adding SUE to the composite REDUCES IC (delta −0.009). Large-cap shows mild REVERSAL.',
  },
  {
  ...
  },
  {
    ...
    evidence: 'commit a862e83 (28-mlrank rerun on panel-v2)',
    note: 'GBM>Ridge IC delta significant but WF DSR 0.51 < 0.95 → research-only, no live ML.',
  },
  {
