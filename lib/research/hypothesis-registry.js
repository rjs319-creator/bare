...
const HYPOTHESES = Object.freeze([
  ...
  // any sleeve alone. Evaluated ONLY on events logged after registration.
  {
    ...
    evidence: 'registered before any prospective row existed; the pre-boundary retrospective read (op=alphabook portfolio block over the live-logged 2026-06..08 ledgers) is recorded as motivating exploratory context in the note after first read',
  ...
  {
    id: 'vrp-overlay-synthetic', familyId: 'volatility-structure', mode: 'exploratory', status: 'open',
    ...
    note: 'Honest framing: VRP harvesting is compensated risk transfer, not mispricing alpha — the “edge” is willingness to bear the left tail plus the discipline of the regime gate (the program’s one validated lever). Synthetic BS pricing without smile is conservative on premium but also has no gap-risk realism; both biases recorded.',
  },
]);
