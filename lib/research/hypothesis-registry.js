...
const HYPOTHESES = Object.freeze([
  ...
  {
    id: 'momentum-wiki-2014-2018', familyId: 'swing-ranking', mode: 'confirmatory', status: 'open',
    ...
    evidence: 'research/data/wiki/coverage-report.json (mirror QC + EDGAR Form-25 real-death join: 879 verified era deaths, 400 in WIKI, 94% end-date agreement ±45d; 20 ticker-reuse collisions; dataset minimum end-year 2014). Motivating exploratory read = the SAME spent 2022-2026 diagnostic as momentum-longer-horizons — permanently excluded from any verdict.',
    note: 'Purpose: closure on the last open lead at zero data cost. A pass here is survivorship-reduced evidence on a liquid curated universe — it can justify (not replace) the full Era-A purchase; a fail closes the free question. The momentum-historical-2010-2021 holdout stays sealed either way.',
  },
  {
...
const HOLDOUTS = Object.freeze([
  ...
  },
  {
    ...
    sealedAt: '2026-08-04', openedAt: null, openedBy: null,
  },
]);
