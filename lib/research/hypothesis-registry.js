...
const HYPOTHESES = Object.freeze([
  ...
  {
    id: 'gapgo-congestion-interaction', familyId: 'intraday-gap', mode: 'exploratory', status: 'open',
    ...
    note: 'Known confound, stated up front: congestion tracks earnings season, and earnings-driven gaps may continue differently for reasons other than attention. The regime-consistency gate is the frozen guard; deeper causal separation (gap-cause × congestion) would be a NEW hypothesis.',
  },
