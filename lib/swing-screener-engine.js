...
function computeRegime(cohort, spyCandles, { smaAt } = require('./screener')) {
  ...
  return { indexAbove200, breadthPct, bearish, riskOn: indexAbove200 === true && (breadthPct == null || breadthPct >= 45) };
}
