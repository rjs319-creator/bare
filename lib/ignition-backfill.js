  ...
  for (const date of dates) {
    ...
    for (const [t, candles] of hist) {
      ...
      dayPicks.push({ ticker: t, section: 'Ignition', tier, date, entry: candles[idx].close,
        ...
        // Explicit data class: the Scoreboard reader reclassifies backfill rows to
        // HIST_* tiers and maturity excludes them from the promoted policy — this
        // record can inform research but can never satisfy prospective confirmation.
