...
| ghost | Ghost Accumulation, ghost-v1 | volume-accumulation | shadow (demoted 2026-08-11) | op=ghostlog; Ghost tab | 0 board; **was** 0.26 of Opportunities client rank (RT-01, fixed this pass) | retire-duplicate (rec) | Measured near-duplicate of screener: overlap 0.797, return corr 0.962, credit 0.359; accumulation evidence already reaches board via evidenceOrigins.volumeAccum; backtest evidence invalidated by Form-4 look-ahead (F-1) |
