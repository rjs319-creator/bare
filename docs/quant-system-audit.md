...
| 11 | Calendar-day purge mishandles holidays | **CONFIRMED (P1)** | `lib/evolve-walkforward.js:31,45` `×1.4` | leak/over-purge near holidays | **FIXED (new path)** exact label-end trading-day purge | label-purge holiday tests |
